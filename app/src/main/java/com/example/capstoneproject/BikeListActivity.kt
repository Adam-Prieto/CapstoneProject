...
class BikeListActivity : AppCompatActivity(), View.OnClickListener,
    View.OnLongClickListener
{
    ...
    private inner class BikeHolder(view: View) : RecyclerView.ViewHolder(view)
    {
        ...
        val totalMileage: TextView = view.findViewById(R.id.txtTotalMile)
        val hoursDriven: TextView = view.findViewById(R.id.txtHours)
    }
    
    // creating adapter inner class
    private inner class BikeAdapter(var bikes: List<Bike>,
                                    var onClickListener: View.OnClickListener,
                                    var onLongClickListener: View.OnLongClickListener) :
        RecyclerView.Adapter<BikeHolder>()
    {
        override fun onCreateViewHolder(parent: ViewGroup,
                                        viewType: Int): BikeHolder
        {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.bikedetail, parent, false)
        ...
        override fun onBindViewHolder(holder: BikeHolder, position: Int)
        {
            ...
            holder.totalMileage.text = bike.totalMile.toString()
            holder.hoursDriven.text = bike.bikeHours
            //holder.hoursDriven.text = BikeDatabaseHelper.TIME_FORMAT.format(bike.bikeHours)
    ...
    fun populateRecyclerView()
    {
        ...
        val cursor = db.query("bikes", null, null, null, null, null, null)
        with(cursor) {
            while (moveToNext())
            {
                val id = getInt(0)
                ...
                val totalMile = getDouble(5)
                val driveTime = getString(6)
                val bike =
                    Bike(id, year, make, model, size, totalMile, driveTime)
                bikes.add(bike)
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        supportActionBar!!.title = "My Bikes"
        ...
        // The intent which directs to my location
        val btnMyLocation: Button = findViewById(R.id.btnMyLocation)
        ...
        val intentSettingsAndConnectivity =
            Intent(this, CheckInternetAndSettingsActivity::class.java)
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle)
    {
        ...
        dbHelper = if (savedInstanceState.containsKey(
                "dbHelper")) savedInstanceState.getSerializable(
            "dbHelper") as BikeDatabaseHelper
        else BikeDatabaseHelper(this)
    }
    ...
    override fun onClick(view: View?)
    {
        ...
        {
            val id =
                view.findViewById<TextView>(R.id.bikeId).text.toString().toInt()
            val intent = Intent(this, BikeActivity::class.java)
    ...
    override fun onLongClick(view: View?): Boolean
    {
        ...
        if (view != null)
        {
            ...
            alertDialogBuilder.setMessage(
                "Are you sure you want to delete item named $id ?")
            alertDialogBuilder.setPositiveButton("Yes",
                MyDialogInterfaceListener(id))
